---
Distâncias e caminhos de grafos - R
---
```{r}
...
Busca a distância
```{r}
#calcula a distância mais curta entre dois vertices (calcula mas não mostra o caminho)
distances(dist,V(dist)$name=="A",V(dist)$name=="H")
#verifica no grafo
plot(dist, edge.label = E(dist)$weight)
#busca o caminho mais curto - output lista de vertices ou arestas, both retorna os dois
